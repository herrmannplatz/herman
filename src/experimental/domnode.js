...
export default class DomNode extends Node {
  ...
  updateMatrix () {
    ...
    if (this.parent) {
      const world = this.parent.matrix.clone()
      this.matrix = world.multiply(this.matrix)
    }

    // TODO cross browser
    const matrixString = 'matrix(' + this.matrix.a11 + ',' + this.matrix.a21 + ',' + this.matrix.a12 + ',' + this.matrix.a22 + ',' + this.matrix.a13 + ',' + this.matrix.a23 + ')'
